  ...
  return (
   <>
      <div className='flex items-center justify-center flex-col h-screen px-11 text-center gap-7'>
        <h1 className='text-base font-medium text-slate-900'> Your Cart is Empty <span>&#9785;</span></h1>
        <img
          src={emptybag}
          alt="emptybag/img"
          className='w-40 lg:w-36 sm:w-28 h-auto object-fill transition-all duration-300 hover:scale-110 z-20'
        />
